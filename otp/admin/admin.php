...
<p><?php echo sprintf($otplangs->trans('OTPAdminAuthorBody'), '<a href="http://www.marcosgdf.com">www.marcosgdf.com</a>') ?></p>
<ul>
...
<p><?php echo sprintf($otplangs->trans('OTPAdminSupport'), '<a href="mailto:hola@marcosgdf.com">hola@marcosgdf.com</a>') ?></p>

<p><?php echo sprintf($otplangs->trans('OTPGift'), '<a href="mailto:hola@marcosgdf.com">hola@marcosgdf.com</a>') ?></p>
